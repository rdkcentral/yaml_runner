...
class SimpleConfigReaderTest(unittest.TestCase):
    ...
    def test_correctly_reads_flags(self):
        config = {
            "hello": {
                "command": "echo {{aflag}}",
                "flags": {
        ...
        flag = commands["hello"].flags["aflag"]
        self.assertEqual(flag.short, "a")
        self.assertEqual(flag.value, "hello")
        self.assertEqual(flag.description, "flag description")

    def test_correctly_reads_options(self):
        config = {
            "hello": {
                "command": "echo {{aflag}}",
                "options": {
        ...
        option = commands["hello"].options["aoption"]
        self.assertEqual(option.short, "a")
        self.assertEqual(option.required, True)
        self.assertEqual(option.description, "option description")

    def test_correctly_reads_arguments(self):
        config = {
            "hello": {
                "command": "echo {{aflag}}",
                "arguments": {
        ...
        argument = commands["hello"].arguments["anargument"]
        self.assertEqual(argument.choices, ["a", "b"])
        self.assertEqual(argument.description, "argument description")
